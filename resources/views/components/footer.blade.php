<footer class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8">
            <div>
                <div class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="text-xl font-semibold">Naturaleaf</span>
                </div>
                <p class="text-gray-400">Your trusted online plant store</p>
            </div>
            <div>
                <h4 class="font-semibold mb-4">Products</h4>
                <ul class="space-y-2 text-gray-400">
                    <li><a href="#" class="hover:text-green-500 transition">Ornamental Plants</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Succulents</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Medicinal Plants</a></li>
                    <li><a href="#" class="hover:text-green-500 transition">Cactus</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Naturaleaf. All rights reserved.</p>
        </div>
    </div>
</footer>